...
Before you can begin interacting with HNS, you will need to obtain a reference to the HNS registry. How you do this depends on the library you are using.
...
// HNS functionality is provided directly on the core provider object.
```
{% endtab %}
